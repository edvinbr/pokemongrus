...
#define ABILITY_INNOCENT_CHARM 312 // intimidate clone for def
//#define ABILITY_FREEZE_TOUCH 313 // 30% apply frostbite on contact

#define ABILITIES_COUNT_GRAVEL 312

#define ABILITIES_COUNT ABILITIES_COUNT_GRAVEL
