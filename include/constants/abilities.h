...
enum __attribute__((packed)) Ability
{
    ...
    // Gen Gravel
    ABILITY_INNOCENT_CHARM = ABILITIES_COUNT_GEN9, // intimidate clone for def
//  ABILITY_FREEZE_TOUCH 312 // 30% apply frostbite on contact
    ABILITIES_COUNT_GRAVEL,
    ABILITIES_COUNT = ABILITIES_COUNT_GRAVEL,
};
